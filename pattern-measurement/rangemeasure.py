...
# Test to see if paths to project and datafile are valid
projectPath = path.dirname(project)
datafilePath = path.dirname(datafile)
if ((projectPath != "") and (not path.exists(projectPath))):
    # Create requested path
    os.makedirs(projectPath, mode=0o755)
    
if ((datafilePath != "") and (not path.exists(datafilePath))):
    os.makedirs(datafilePath, mode=0o755)
else:   # Make sure the file doesn't already exist
    if path.exists(datafile):
        print("WARNING: Overwriting data file.")
